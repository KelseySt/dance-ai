...
function VideoComponent({ title , url = "http://localhost:3000/public/student.mp4" }) {   
  return (
    <div
      className="bg-[#333] justify-items-center mx-3 my-15 border border-gray-600 rounded col-span-2"
    >
        <div  className='w-full h-full'>
            <ReactPlayer url={url} width="100%" height="100%" controls={true} type="video/mp4" onProgress={(progress) => {
